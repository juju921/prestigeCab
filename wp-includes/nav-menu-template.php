...
function wp_nav_menu( $args = array() ) {
	...
	'echo' => true, 'fallback_cb' => 'wp_page_menu', 'before' => '', 'after' => '', 'link_before' => '', 'link_after' => '', 'items_wrap' => '<ul id="%1$s" class="%2$s nav nav-pills nav-justified">%3$s</ul>', 'item_spacing' => 'preserve',
